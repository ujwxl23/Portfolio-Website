...
export function ContactUsForm() {
  ...
  return (
    <div className="max-w-md w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input bg-black">
      ...
      <p className=" text-sm max-w-sm my-4 text-neutral-300">
      ...
      <a
        ...
        className="bg-gradient-to-br relative group/btn  from-zinc-900 to-zinc-900  bg-zinc-800 w-full text-white rounded-md h-10 font-medium shadow-[0px_1px_0px_0px_var(--zinc-800)_inset,0px_-1px_0px_0px_var(--zinc-800)_inset] text-center flex items-center justify-center"
      >
        Resume &rarr;
        <BottomGradient />
      </a>
